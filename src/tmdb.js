        ...
        return[
            {
                ...
                itens: await basicFetch(`/discover/tv?with_network=213&languege=pt-BR&api_key=${API_KEY}`)
            },
            {
                slug: 'trending',
                title: 'Recomendados para você',
                itens: await basicFetch(`/treding/al/week?language=pt-BR&api_key${API_KEY}`)
            },
            {
                slug: 'toprated',
                title: 'Em alta',
